...
Now that we came to know about the data that we are using for the prediction let us perform some EDA (Exploratory data aanalysis) to understand the relationship between various input variables and its variation with the output
